 ...
 */
public class DeflateEncodingTest extends TestCase {
    private static final Logger logger = Grizzly.logger(DeflateEncodingTest.class);

    public static int PORT = 19006;

    private final FutureImpl<Throwable> exception = SafeFutureImpl.create();

    public void testDeflateResponse() throws Throwable {
        DeflateContentEncoding deflateServerContentEncoding =
                new DeflateContentEncoding(512, 512, new EncodingFilter() {
            @Override
            public boolean applyEncoding(HttpHeader httpPacket) {
                ...
                return bc != null && bc.indexOf("deflate", 0) != -1;
            }
        ...
        DeflateContentEncoding deflateClientContentEncoding =
                new DeflateContentEncoding(512, 512, new EncodingFilter() {
            @Override
            public boolean applyEncoding(HttpHeader httpPacket) {
                return false;
        ...
        doTest(request, result, deflateServerContentEncoding, deflateClientContentEncoding);
    }


    public void testDeflateRequest() throws Throwable {
        DeflateContentEncoding deflateServerContentEncoding =
                new DeflateContentEncoding(512, 512, new EncodingFilter() {
            @Override
            public boolean applyEncoding(HttpHeader httpPacket) {
        ...
        String reqString = "Deflated hello. Works?";
        ...
        HttpRequestPacket request = HttpRequestPacket.builder()
            ...
            .contentLength(deflatedContent.length)
            .build();
        
        HttpContent reqHttpContent = HttpContent.builder(request)
                .last(true)
                .content(Buffers.wrap(mm, deflatedContent))
                .build();
        ...
        doTest(reqHttpContent, result, deflateServerContentEncoding, deflateClientContentEncoding);
    }


    public void testDeflateRequestResponse() throws Throwable {
        DeflateContentEncoding deflateServerContentEncoding =
                new DeflateContentEncoding(512, 512, new EncodingFilter() {
            @Override
            public boolean applyEncoding(HttpHeader httpPacket) {
    ...
    public void testDeflatedRequestResponseChunkedXferEncoding() throws Throwable {
        DeflateContentEncoding deflateServerContentEncoding =
                new DeflateContentEncoding(512, 512, new EncodingFilter() {
            @Override
            public boolean applyEncoding(HttpHeader httpPacket) {
